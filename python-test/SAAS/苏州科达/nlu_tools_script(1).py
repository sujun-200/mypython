...
def argparser():
    ...
    parser.add_argument("-address", help="ip和端口", type=str, default='http://10.12.7.235:50006')
    ...
    parser.add_argument("-pid", help="产品id", type=str, default='914004103')

    parser.add_argument("-inverse_address", help="逆文本地址", type=str, default='http://10.12.7.235:40080/inverse')
